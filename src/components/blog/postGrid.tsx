...
import { T_PostsState, showLessItem } from "../../store/reducers/_posts";
import Post from "../blog/post";
import { T_AppStoreReducers } from "../../store";

const PostGrid = ({ IS_HOME_PAGE = true }) => {
    const { data: posts, itemsToShow } = useSelector<T_AppStoreReducers, T_PostsState>((state) => state.$_posts);
